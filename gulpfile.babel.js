...
gulp.task('clean', del.bind(null, ['app/js/main.js', 'app/js/**.min.js', 'dist/css/style.min.css', 'dist/fonts', 'dist/images', 'dist/index.html', 'dist/js/main.min.js'], {read: false}))
...
gulp.task('lint', () => {
  return gulp.src(['*/**/*.js', '!node_modules/**', '!test/**', '!**/*.min.js'])
    .pipe(eslint())
    .pipe(eslint.format())
